function _tide_remove_unusable_items
    ...
    set -l removed_items
    for item in aws bun crystal direnv distrobox docker elixir gcloud git go java kubectl nix_shell node openstack php pulumi python ruby rustc terraform toolbox zig
